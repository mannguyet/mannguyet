 ...
 */
// JSON.stringify(value) -> convent giá trị sang dưới dạng JSON string
// toString()
...
// [1,2] [3,4] [5,6] -> [1,2,3,4,5,6] gộp mảng
// C1 concat
...
const [ball,sword,arrrow,...rest] = toys; // lay ca gia tri con lai
console.log(rest);
// rest parameter ...
